...
exports.SimpleUserRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
const crypto_util_1 = require("../common/utils/crypto.util");
let SimpleUserRepository = class SimpleUserRepository {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
...
exports.SimpleUserRepository = SimpleUserRepository;
exports.SimpleUserRepository = SimpleUserRepository = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], SimpleUserRepository);
//# sourceMappingURL=simple-user.repository.js.map