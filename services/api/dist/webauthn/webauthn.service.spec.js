...
describe('WebAuthnService', () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(webauthn_service_1.WebAuthnService);
    ...
    describe('generateRegistrationOptions', () => {
        ...
        it('should throw error if user not found', async () => {
            ...
            await expect(service.generateRegistrationOptions('user-id')).rejects.toThrow('User not found');
        });
    });
    ...
    describe('verifyAuthentication', () => {
        it('should throw error if authenticator not found', async () => {
            ...
            await expect(service.verifyAuthentication(mockResponse, 'challenge', 'user-id')).rejects.toThrow('Authenticator not found');
        });
        it('should throw error if authenticator does not belong to user', async () => {
            ...
            await expect(service.verifyAuthentication(mockResponse, 'challenge', 'user-id')).rejects.toThrow('Authenticator does not belong to user');
        });
    });
});
//# sourceMappingURL=webauthn.service.spec.js.map